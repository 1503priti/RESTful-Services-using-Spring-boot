...
import co.priti.dao.CustomerRespository;
...
public class CustomerRestController {
	...
	@GetMapping
	public Iterable<Customer> getAllCustomers(@RequestParam(name = "_page", defaultValue = "1") Integer pageNum,
